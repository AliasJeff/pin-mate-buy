...
CREATE TABLE `group_buy_activity` (
  ...
  `take_limit_count` int NOT NULL DEFAULT '1' COMMENT '拼单次数限制',
  `target` int NOT NULL DEFAULT '1' COMMENT '拼单目标',
  `valid_time` int NOT NULL DEFAULT '15' COMMENT '拼单时长（分钟）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='拼单活动';
