package com.alias.test.domain.activity;
...
import com.alias.domain.activity.service.IIndexGroupBuyMarketService;
...
public class IndexGroupBuyMarketServiceTest {
    ...
    public void test_indexMarketTrial() throws Exception {
        ...
        marketProductEntity.setUserId("alias");
    ...
    public void test_indexMarketTrial_no_tag() throws Exception {
        MarketProductEntity marketProductEntity = new MarketProductEntity();
        marketProductEntity.setUserId("no_tag_user");
        marketProductEntity.setSource("s01");
        marketProductEntity.setChannel("c01");
        marketProductEntity.setGoodsId("9890001");
